        ...
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                <td width="350" valign="top">
                    <form action="<?php echo U('Show/insert');?>" method="post" enctype="multipart/form-data">
                    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
                        <tr>
                            <td><b><?php echo L('show_name');?></b>
                                <input type="text" name="show_name" size="20" class="inpMain" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><b><?php echo L('show_link');?></b>
                                <input type="text" name="show_link"  size="40" class="inpMain" />
                            </td>
                        </tr>
                        <tr>
                            <td><b><?php echo L('sort');?></b>
                                <input type="text" name="sort"  size="20" class="inpMain" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <td valign="top">
                    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
                        ...
                        <?php if(is_array($show_list)): $i = 0; $__LIST__ = $show_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$show_list): $mod = ($i % 2 );++$i;?><tr>
