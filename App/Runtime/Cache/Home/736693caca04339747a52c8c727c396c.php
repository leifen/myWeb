...
<!-- dcHead 结束 -->
    ...
    <div class="wrap mb">
        <div id="pageLeft">
            ...
            <div class="treeBox">
                <h3><?php echo L('project_tree');?></h3>
                <ul>
                    <?php if(is_array($project_category)): $i = 0; $__LIST__ = $project_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i; if($cate['cur']): ?><li class="cur"><?php else: ?><li><?php endif; ?>
        ...
        <div id="pageIn">
            ...
            <div class="urHere"><?php echo L('ur_here');?>：
                ...
                <a href="<?php echo ($system_module["project_category"]); ?>"><?php echo L('project_category');?></a>
                <?php if($ur_here): ?><b>></b><?php echo ($ur_here); endif; ?>
            </div>

            <div id="articleList">
                <?php if(is_array($project_list)): $k = 0; $__LIST__ = $project_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$project): $mod = ($k % 2 );++$k; if($k == count($project_list)): ?><dl class="last"><?php else: ?><dl><?php endif; ?>
                        <div class="numDate"> <em><?php echo ($project["click"]); ?></em>
                            <p><?php echo (date("m-d",$project["add_time"])); ?></p>
                        </div>
                        <dt><a href="<?php echo ($project["url"]); ?>"><?php echo ($project["title"]); ?></a></dt>
                        <dd>
                            <?php if($project['image']): ?><p class="img"><img src="/<?php echo ($project["image"]); ?>" height="42"></p><?php endif; ?>
