...
<!-- dcHead 结束 -->
    ...
    <div class="wrap mb">
        ...
        <div id="pageIn">
            ...
            <div id="product">
                <div class="productImg"><a href="/<?php echo ($case["image"]); ?>" target="_blank"><img src="/<?php echo ($case["image"]); ?>" width="300" /></a></div>
                <div class="productInfo">
                    <h1><?php echo ($case["name"]); ?></h1>
                    <ul>
                        <li><?php echo L('case_description');?>：<?php echo ($case["description"]); ?></li>
