...
<!-- dcHead 结束 -->
    ...
    <div class="wrap mb">
        ...
        <div id="pageIn">
            ...
            <div id="product">
                <div class="productImg"><a href="/myweb/<?php echo ($product["image"]); ?>" target="_blank"><img src="/myweb/<?php echo ($product["image"]); ?>" width="300" /></a></div>
                <div class="productInfo">
                    <h1><?php echo ($product["name"]); ?></h1>
                    <ul>
                        <li class="productPrice"><?php echo L('price');?>：<em class="price"><?php echo ($product["price"]); ?></em></li>
                        <?php if(!empty($product['defined'])): if(is_array($product['defined'])): $i = 0; $__LIST__ = $product['defined'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$defined): $mod = ($i % 2 );++$i;?><li><?php echo ($defined["arr"]); ?>：<?php echo ($defined["value"]); ?></li><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                    </ul>
                </div>
                <div class="clear"></div>
                <div class="productContent">
                    <h3><?php echo L('product_content');?></h3>
                    <ul>
