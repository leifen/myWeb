...
<!-- dcHead 结束 -->
    ...
    <div class="wrap mb">
        <div id="pageLeft">
            <div class="treeBox">
                <h3><?php echo L('about_tree');?></h3>
                <ul>
                    <?php if($top_cur): ?><li class="cur"><?php else: ?><li><?php endif; ?>
                        <a href="<?php echo ($top["url"]); ?>"><?php echo ($top["page_name"]); ?></a>
                    </li>
                    <?php if(is_array($page_list)): $i = 0; $__LIST__ = $page_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i; if($list['cur']): ?><li class="cur"><?php else: ?><li><?php endif; ?>
                            <a href="<?php echo ($list["url"]); ?>"><?php echo ($list["page_name"]); ?></a>
                        </li>
                        <?php if($list['child']): ?><ul>
                            <?php if(is_array($list['child'])): $i = 0; $__LIST__ = $list['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i; if($child['cur']): ?><li class="cur"><?php else: ?><li><?php endif; ?>
                                -<a href="<?php echo ($child["url"]); ?>"><?php echo ($child["page_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div id="pageIn">
            ...
            <div class="urHere"><?php echo L('ur_here');?>：<a href="<?php echo ($config["root_url"]); ?>"><?php echo L('home');?></a><b>></b><?php echo ($ur_here); ?></div>
