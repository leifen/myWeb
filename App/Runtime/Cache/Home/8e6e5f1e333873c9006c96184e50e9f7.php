...
<!-- dcHead 结束 -->
    ...
    <div class="wrap mb">
        ...
        <div id="pageLeft">
            <div class="treeBox">
                <h3><?php echo L('product_tree');?></h3>
                <ul>
                    <?php if(is_array($product_category)): $i = 0; $__LIST__ = $product_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i; if($cate['cur']): ?><li class="cur"><?php else: ?><li><?php endif; ?>
        ...
        <div id="pageIn">
            ...
            <div class="urHere"><?php echo L('ur_here');?>：
                ...
                <a href="<?php echo ($system_module["product_category"]); ?>"><?php echo L('product_category');?></a>
                <?php if($ur_here): ?><b>></b><?php echo ($ur_here); endif; ?>
            </div>

            <div class="productList">
                <?php if(is_array($product_list)): $k = 0; $__LIST__ = $product_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$product): $mod = ($k % 2 );++$k; if($k == count($product_list)): ?><dl class="last"><?php else: ?><dl><?php endif; ?>
                    <dt>
                        <a href="<?php echo ($product["url"]); ?>">
                        <img src="<?php echo ($product["thumb"]); ?>" alt="<?php echo ($product["name"]); ?>" width="<?php echo ($config["thumb_width"]); ?>" height="<?php echo ($config["thumb_height"]); ?>" />
                        </a>
                    </dt>
                    <dd>
                        <p class="name"><a href="<?php echo ($product["url"]); ?>" title="<?php echo ($product["name"]); ?>"><?php echo ($product["name"]); ?></a></p>
                        <p class="brief"><?php echo ($product["description"]); ?></p>
                        <p class="price"><?php echo L('price');?>：<?php echo ($product["price"]); ?></p>
                        <p><a href="<?php echo ($product["url"]); ?>" class="btn"><?php echo L('product_buy');?></a></p>
                    </dd>
