...
<!-- dcHead 结束 -->
    ...
    <div class="wrap mb">
        ...
        <div id="pageIn">
            ...
            <div id="articleList">
                <?php if(is_array($article_list)): $k = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($k % 2 );++$k; if($k == count($product_list)): ?><dl class="last"><?php else: ?><dl><?php endif; ?>
                        <div class="numDate"> <em><?php echo ($article["click"]); ?></em>
                            <p><?php echo (date("m-d",$article["add_time"])); ?></p>
                        </div>
                        <dt><a href="<?php echo ($article["url"]); ?>"><?php echo ($article["title"]); ?></a></dt>
                        <dd>
                            <?php if($article['image']): ?><p class="img"><img src="/<?php echo ($article["image"]); ?>" height="42"></p><?php endif; ?>
